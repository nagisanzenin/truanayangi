...
export const copy = {
  vi: {
    ...
    vegetarianOnly: 'Chỉ ăn chay', vegetarian: 'Ăn chay', capBudget: 'Không vượt ngân sách', opening: 'ĐANG MỞ HÒM…', openAgain: 'MỞ LẠI', open: 'MỞ HÒM',
  ...
  en: {
    ...
    vegetarianOnly: 'Vegetarian only', vegetarian: 'Vegetarian', capBudget: 'Never exceed budget', opening: 'OPENING CASE…', openAgain: 'OPEN AGAIN', open: 'OPEN CASE',
