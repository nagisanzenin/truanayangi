...
export const copy = {
  vi: {
    ...
    inventory: 'Kho của tôi', inventoryEmpty: 'Kho trống. Mở hòm để nhận món đầu tiên.',
    inventoryCount: 'món trong kho', inventoryFull: 'Kho đã đầy, món cũ nhất sẽ bị đẩy ra.',
    inventoryNotSaved: 'Không lưu được kho bằng cookie. Kho chỉ giữ trong lần mở trang này.',
    tradeUp: 'GHÉP MÓN', tradeUpTitle: 'Ghép món', tradeUpLead: 'Chọn 8 món cùng bậc để đổi lấy 1 món bậc cao hơn.',
    tradeUpSelected: 'Đã chọn', tradeUpNeed: 'Cần đủ 8 món cùng một bậc.',
  ...
  en: {
    ...
    inventory: 'My inventory', inventoryEmpty: 'Nothing yet. Open a case to collect your first dish.',
    inventoryCount: 'dishes collected', inventoryFull: 'Inventory is full; the oldest dish drops out.',
    inventoryNotSaved: 'Cookies unavailable, so the inventory lasts only for this visit.',
    tradeUp: 'TRADE UP', tradeUpTitle: 'Trade up', tradeUpLead: 'Pick eight dishes of one tier to trade for a dish one tier higher.',
    tradeUpSelected: 'Selected', tradeUpNeed: 'Pick eight dishes of a single tier.',
