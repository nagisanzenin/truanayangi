...
export const copy = {
  vi: {
    ...
    region: 'Vùng miền', regions: {all: 'Tất cả', north: 'Miền Bắc', central: 'Miền Trung', south: 'Miền Nam', intl: 'Quốc tế'},
  ...
  en: {
    ...
    region: 'Region', regions: {all: 'All', north: 'Northern', central: 'Central', south: 'Southern', intl: 'International'},
