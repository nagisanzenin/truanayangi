...
export default function Home(){
 ...
 useEffect(()=>{
  const engine=new CaseAudio(basePath);engine.setMuted(!sound);audio.current=engine;engine.preload();
